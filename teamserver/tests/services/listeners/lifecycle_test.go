...
// func (m *MockLifecycleManager) Stop(ctx context.Context, listener *services.Listener) error {
// 	args := m.Called(ctx, listener)
// 	return args.Error(0)
// }

// func (m *MockLifecycleManager) Terminate(ctx context.Context, listener *services.Listener) error {
// 	args := m.Called(ctx, listener)
// 	return args.Error(0)
// }

// func (m *MockLifecycleManager) UpdateConfig(ctx context.Context, listener *services.Listener, config services.ListenerConfig) error {
// 	args := m.Called(ctx, listener)
// 	return args.Error(0)
// }
...
// 	tests := []struct {
// 		name       string
// 		config     services.ListenerConfig
// 		endStatus  string
// 		startError error // error for internal listener implementation
// 	}{
// 		{
// 			name:       "successful-start",
// 			config:     services.makeValidListenerConfig("test-listener-id", "http", services.StatusReady),
// 			endStatus:  services.StatusRunning,
// 			startError: nil,
// 		},
// 		{
// 			name:       "start-error",
// 			config:     services.makeValidListenerConfig("test-listener-id", "http", services.StatusReady),
// 			endStatus:  services.StatusStarting,
// 			startError: errors.New("listener failed to start"),
// 		},
// 		{
// 			name:       "nil-listener",
// 			config:     services.makeValidListenerConfig("test-listener-id", "http",services. StatusReady),
// 			endStatus:  services.StatusReady,
// 			startError: nil,
// 		},
// 	}
...
// 			tc.config.Deployment = services.LifecycleManaged
// 			listener, err := services.NewListenerFromConfig(tc.config)
