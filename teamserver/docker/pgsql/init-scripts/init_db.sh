...
tables=("users" "listeners" "agents" "agent_config" "agent_info" "agent_task" "agent_command" "payload_manifests" "payloads" "modules" "teams" "team_members" "certificates" "payload_build_jobs")
