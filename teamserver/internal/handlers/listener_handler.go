...
type ListenerHandler struct {
	dal     services.IListenerDAL
	service *services.ListenerService
}

func NewListenersHandler(dal services.IListenerDAL, service *services.ListenerService) *ListenerHandler {
