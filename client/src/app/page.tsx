...
export default function Home() {
  ...
  return (
    ...
    <div className="w-[calc(100vw-var(--sidebar-width))] flex flex-col gap-4 justify-items-center p-0 mb-4 m-6 overflow-x-hidden">
      ...
      <div className="flex flex-row gap-4 w-[calc(95vw-var(--sidebar-width))] h-[74vh]">
        <Card className="w-[60%]">
